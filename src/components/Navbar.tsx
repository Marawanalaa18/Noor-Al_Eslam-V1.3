...
import { Moon, Sun, Menu, X, BookOpen, Headphones, Clock, Heart, Activity, Target, Settings as SettingsIcon, Book } from 'lucide-react';
...
export function Navbar() {
  ...
  const toggleDark = () => setIsDark(!isDark);
    ...
    const links = [
      ...
      { name: 'الأحاديث', path: '/hadith', icon: <Book className="w-5 h-5" /> },
