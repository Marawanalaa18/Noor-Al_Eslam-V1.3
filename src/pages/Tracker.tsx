...
export function Tracker() {
  ...
  const [activeTab, setActiveTab] = useState<'daily' | 'jannah' | 'stats' | 'progress' | 'khatma' | 'tasbeeh'>('daily');
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center gap-2 bg-gray-100 dark:bg-surface-dark p-1.5 rounded-2xl w-fit mx-auto flex-wrap">
        ...
        <TabButton active={activeTab === 'tasbeeh'} onClick={() => setActiveTab('tasbeeh')} icon={<Circle className="w-4 h-4" />}>سبحة إلكترونية</TabButton>
